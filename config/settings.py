...
CHOICE_FIELD_DB = BASE_DIR / "users" / "resources" / "valid_options.json"
...
FLUTTERWAVE_SUCCESS_URL = os.getenv("FLUTTERWAVE_SUCCESS_URL")
FLUTTERWAVE_FAILURE_URL = os.getenv("FLUTTERWAVE_FAILURE_URL")
...
JITSI_KEY_ID=os.getenv("JITSI_KEY_ID")
